...
def evaluate(model: TDLGM, loader: DataLoader) -> float:
    ...
    for batch in loader:
        ...
        losses.append(float(model.nllLoss(mean, y, logvar.exp())))
    model.train()
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--hidden_dim", type=int, default=32, help="Hidden size for the model")
    parser.add_argument("--latent_dim", type=int, default=8, help="Latent dimension for the model")
    ...
    parser.add_argument("--artifact_dir", type=str, default="artifacts/rvae", help="Directory to save checkpoints.")
